...
class DictionaryFeatures:
    def __init__(self, dictDir):
        ...
        for d in os.listdir(dictDir):
            ...
            for line in open(dictDir + "/" + d):
                ...
                if not word in self.word2dictionaries:            #Tab-seperated string is more memory efficient than a list?
    ...
    def GetDictFeatures(self, words, i):
        ...
        if self.brownClusters and words[i].lower() in self.brownClusters:
            for j in [4, 8, 12]:
